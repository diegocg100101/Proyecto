...
bool kalanchoe_interface__msg__measure__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kalanchoe_interface.msg._measure.Measure", full_classname_dest, 40) == 0);
  }
  kalanchoe_interface__msg__Measure * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of Measure */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kalanchoe_interface.msg._measure");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Measure");
